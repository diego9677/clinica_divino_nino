...
from .views import ReservaListView, ReservaCreateView, DoctorListView, DoctorCreateView, DoctorDeleteView, \
    DoctorUpdateView, PacienteListView, PacienteCreateView, PacienteUpdateView, PacienteDeleteView
...
urlpatterns = [
    ...
    path('reservas-create/<int:paciente_id>/', ReservaCreateView.as_view(), name='reserva-create'),
